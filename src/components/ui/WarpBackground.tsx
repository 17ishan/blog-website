...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  return (
    <div className={cn("relative rounded border h-full p-5 md:p-16", className)} {...props}>
      <div
        style={
          {
        ...
        className={ 
          "h-full pointer-events-none absolute left-0 top-0 size-full overflow-hidden [clipPath:inset(0)] [container-type:size] [perspective:var(--perspective)] [transform-style:preserve-3d]"
        }
      >
        {/* top side */}
